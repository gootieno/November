...
import * as stuff from "./quotes/mrsPotatoHead.js";
  ...
  start() {
    document.getElementById("hello").addEventListener("click", () => {
      ...
      if (index === 1) {
        ...
        messageContainer.innerText = stuff.mrsPotatoHeadQuotes["hello"];
      }
    ...
    document.getElementById("bye").addEventListener("click", () => {
      ...
      if (index === 1) {
        ...
        messageContainer.innerText = stuff.mrsPotatoHeadQuotes["bye"];
      }
    });
